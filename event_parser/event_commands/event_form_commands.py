...
EventFormCommands = MappingProxyType({
	...
	23: EventCommand(2, "G2_cha_flag", {0: ("CHANO", 0)}, "Checks `G2_cha_flag(param2, param1)` <br/> param1 = character number (`chano`) <br /> param2 = mode: `4` = character recruited, not dead or on leave, not in party; `9` = character in party"),
	24: EventCommand(2, "G2_cha_flag", {0: ("CHANO", 0)}, "Checks `G2_cha_flag(param2, param1)` <br/> param1 = character number (`chano`) <br /> param2 = mode"),
