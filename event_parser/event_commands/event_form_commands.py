...
EventFormCommands = MappingProxyType({
	...
	3: EventCommand(2, "event_flag_NAND", {0: "EVENT_FLAG"}, "Checks `event_flag` `!(event_flag[param1] & param2)` -- inverse logic of cmd 4"),
	4: EventCommand(2, "event_flag_AND", {0: "EVENT_FLAG"}, "Checks `event_flag` `event_flag[param1] & param2` -- inverse logic of cmd 3"),
	...
	8: EventCommand(1, "direction", {}, "Checks `SYS_WORK pad_dat` bits, which are set based on direction; param1 has values 0-3"),
	...
	16: EventCommand(2, "char_in_party", {1: "CHANO"}, "Checks if a character (by `chano`) is in party (param2). param1 controls the boolean logic: <br> param1 == 1 && in_party(param2): execute next command <br /> param1 == 1 && !in_party(param2): return 0 (stop script) <br /> param1 == 0 && in_party(param2): return 0 <br /> param1 == 0 && !in_party(param2): execute next command"),
	17: EventCommand(0, "N/A", {}, "Default case -- just returns 0"),
	18: EventCommand(2, "potch", {}, "Checks if param2 * 100 <= party gold (potch)"),
	19: EventCommand(1, "event_flag_255_NAND", {}, "Checks `!(event_flag[255] & param1)` -- inverse logic of cmd 20"),
	20: EventCommand(1, "event_flag_255_AND", {}, "Checks `event_flag[255] & param1` -- inverse logic of cmd 19"),
	21: EventCommand(1, "direction", {}, "Checks `SYS_WORK pad_dat` bits, which are set based on direction; param1 has values 0-3"),
	22: EventCommand(1, "player", {}, "Checks `EVENT_HUMAN[0]` field against param1"),
	23: EventCommand(2, "G2_cha_flag", {0: "CHANO"}, "Checks `G2_cha_flag(param2, param1)` <br/> param1 = character number (`chano`) <br /> param2 = mode: `4` = character recruited, not dead or on leave, not in party; `9` = character in party"),
	24: EventCommand(2, "G2_cha_flag", {0: "CHANO"}, "Checks `G2_cha_flag(param2, param1)` <br/> param1 = character number (`chano`) <br /> param2 = mode"),
	25: EventCommand(1, "rand", {}, "Checks random number between 0 and param1"),
	26: EventCommand(5, "G2_item_num2", {}, "Checks `G2_item_num2`"),
	27: EventCommand(2, "t_box_flag", {}, "Checks `GAME_WORK t_box_flag[param1] & param2`"),
	28: EventCommand(2, "t_box_flag", {}, "Checks `GAME_WORK t_box_flag[param1] & param2`"),
	29: EventCommand(2, "map_in_out_flag_NAND", {}, "Checks `!(map_in_out_flag[param1] & param2)`"),
	30: EventCommand(2, "map_in_out_flag_AND", {}, "Checks `map_in_out_flag[param1] & param2`"),
	31: EventCommand(4, "px", {}, "Checks `px`"),
	...
	37: EventCommand(5, "event_time", {}, "Checks `GAME_WORK event_time`"),
	38: EventCommand(2, "G2_pamem_num", {}, "Checks `G2_pamem_num(0)` and `(4)`"),
	39: EventCommand(3, "G2_chara_love", {1: "CHANO"}, "Checks G2_chara_love; param1 is a mode of some sort. param2 = chano"),
	40: EventCommand(2, "shop_data", {}, "Checks `GAME_WORK shop_data.event_no` against param2"),
	41: EventCommand(-1, "px_py", {}, "Variable parameters; checks px and py"),
